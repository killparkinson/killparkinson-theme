...
<section class="wp-block-group py-5 hide-wp-block-classes"><!-- wp:group {"metadata":{"name":"container h-100"},"className":"container h-100","layout":{"type":"default"}} -->
...
<figure class="wp-block-image rounded mb-0"><img src="https://dummyimage.com/1200x900/6c757d/ffffff" alt="" style="aspect-ratio:3/4;object-fit:cover"/></figure>
<!-- /wp:image -->
</div>
...
<div class="mb-0 d-flex flex-row gap-2">
    <button class="btn btn-lg btn-secondary" href="#">Primary Button</button>
