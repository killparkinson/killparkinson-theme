...
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"s - Hero image right - py-5 hide-wp-block-classes","categories":["bootscore"],"patternName":"bootscore/section-hero-img-right"},"className":"bg-body-tertiary py-5 hide-wp-block-classes","layout":{"type":"default"}} -->
<section class="wp-block-group py-5 hide-wp-block-classes">
  ...
  <div class="wp-block-group container">
    ...
    <div class="wp-block-group row hero-section align-items-center hide-wp-block-classes">
      ...
      <div class="wp-block-group col-lg-6 mb-3 mb-lg-0 order-lg-2">
        <!-- wp:group {"layout":{"type":"default"} class="h-100"} -->
        <div class="wp-block-group h-100 ">
          <!-- wp:image {"sizeSlug":"full","metadata":{"name":"rounded mb-0"},"className":"rounded mb-0"} -->
          <figure class="wp-block-image size-full rounded mb-0"><img src="https://dummyimage.com/1200x900/6c757d/ffffff"
              alt="" /></figure>
          <!-- /wp:image -->
        </div>
        <!-- /wp:group -->
      ...
      <div class="wp-block-group col-lg-6">
        ...
        <div class="wp-block-group d-flex align-items-center p-md-4">
          ...
          <div class="wp-block-group text-block py-6 ">
            ...
            <h2 class="wp-block-heading display-5 fw-bold mb-2">Section with <span class="text-primary">hero</span></h2>
            <!-- /wp:heading -->
