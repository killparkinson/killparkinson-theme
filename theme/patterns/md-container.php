...
<div class="wp-block-group container-sm hide-wp-block-classes">
	<!-- wp:paragraph {"className":"placeholder bg-primary h-65"} -->
	<p class="placeholder">This is a <code>container</code></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->